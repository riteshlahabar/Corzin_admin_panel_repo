...
<div class="row">
    <div class="col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm text-white" style="background: linear-gradient(135deg, #15803d, #4ade80);"><div class="card-body"><div class="row d-flex justify-content-center"><div class="col-9"><p class="mb-0 fw-semibold fs-14" style="color: rgba(255,255,255,.8);">Farmer Earnings</p><h3 class="mt-2 mb-0 fw-bold">Rs {{ number_format($totalFarmerEarning, 2) }}</h3><small style="color: rgba(255,255,255,.82);">{{ $farmerTrend >= 0 ? '+' : '' }}{{ $farmerTrend }}% this month</small></div><div class="col-3 align-self-center"><div class="d-flex justify-content-center align-items-center thumb-xl bg-white bg-opacity-25 rounded-circle mx-auto"><i class="iconoir-droplet h1 align-self-center mb-0 text-white"></i></div></div></div></div></div>
    </div>
    <div class="col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm text-white" style="background: linear-gradient(135deg, #1d4ed8, #60a5fa);"><div class="card-body"><div class="row d-flex justify-content-center"><div class="col-9"><p class="mb-0 fw-semibold fs-14" style="color: rgba(255,255,255,.8);">Doctor Earnings</p><h3 class="mt-2 mb-0 fw-bold">Rs {{ number_format($totalDoctorEarning, 2) }}</h3><small style="color: rgba(255,255,255,.82);">{{ $doctorTrend >= 0 ? '+' : '' }}{{ $doctorTrend }}% this month</small></div><div class="col-3 align-self-center"><div class="d-flex justify-content-center align-items-center thumb-xl bg-white bg-opacity-25 rounded-circle mx-auto"><i class="iconoir-health-shield h1 align-self-center mb-0 text-white"></i></div></div></div></div></div>
    </div>
    <div class="col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm text-white" style="background: linear-gradient(135deg, #7c3aed, #a78bfa);"><div class="card-body"><div class="row d-flex justify-content-center"><div class="col-9"><p class="mb-0 fw-semibold fs-14" style="color: rgba(255,255,255,.8);">Combined Earnings</p><h3 class="mt-2 mb-0 fw-bold">Rs {{ number_format($totalCombinedEarning, 2) }}</h3><small style="color: rgba(255,255,255,.82);">{{ $combinedTrend >= 0 ? '+' : '' }}{{ $combinedTrend }}% this month</small></div><div class="col-3 align-self-center"><div class="d-flex justify-content-center align-items-center thumb-xl bg-white bg-opacity-25 rounded-circle mx-auto"><i class="iconoir-dollar-circle h1 align-self-center mb-0 text-white"></i></div></div></div></div></div>
    </div>
    <div class="col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm text-white" style="background: linear-gradient(135deg, #b45309, #f59e0b);"><div class="card-body"><div class="row d-flex justify-content-center"><div class="col-9"><p class="mb-0 fw-semibold fs-14" style="color: rgba(255,255,255,.8);">This Month</p><h3 class="mt-2 mb-0 fw-bold">Rs {{ number_format($thisMonthCombined, 2) }}</h3><small style="color: rgba(255,255,255,.82);">Farmer: Rs {{ number_format($thisMonthFarmer, 2) }} | Doctor: Rs {{ number_format($thisMonthDoctor, 2) }}</small></div><div class="col-3 align-self-center"><div class="d-flex justify-content-center align-items-center thumb-xl bg-white bg-opacity-25 rounded-circle mx-auto"><i class="iconoir-calendar h1 align-self-center mb-0 text-white"></i></div></div></div></div></div>
    </div>
</div>
