...
Route::prefix('animal')->group(function () {
    ...
    Route::post('/sell/{animal_id}/cancel', [AnimalController::class, 'cancelForSale']);
    Route::get('/for-sale', [AnimalController::class, 'forSaleList']);
    ...
    Route::post('/pans/{panId}/delete', [AnimalController::class, 'deletePan']);
...
Route::prefix('milk')->group(function () {
    ...
    Route::post('/pan', [MilkProductionController::class, 'storePan']);
...
Route::prefix('health')->group(function () {
    ...
    Route::post('/mastitis/treatment', [HealthController::class, 'storeMastitisTreatment']);
    Route::post('/mastitis/recover', [HealthController::class, 'recoverMastitis']);
...
Route::prefix('doctor')->group(function () {
    ...
    Route::post('/forgot-password/lookup', [DoctorAppController::class, 'forgotPasswordLookup']);
